        ...
        AssignedSchedule: {
            ...
            Steps: {
                ...
                InitStepView: function(periodicStepId) {
                    ...
                    $(wrap).children(".panel-wrap").on("click", "span.fa-chevron-down", fxOpen);
                    //collapse
                    $(wrap).children(".panel-wrap").on("click", "span.fa-chevron-up", fxClose);

                    $(wrap).children(".panel-wrap").on("click", "svg.fa-chevron-down", fxOpen);
                    //collapse
                    $(wrap).children(".panel-wrap").on("click", "svg.fa-chevron-up", fxClose);
                },
